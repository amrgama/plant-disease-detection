...
const AboutAppleScabDisease = () => {
  return (
    <div id='aboutAppleScabDisease' className='col-12 col-lg-9 d-flex flex-column'>
      <h1 className='fs-5 pt-4 fs-bold text-primary'>About Apple Scab Disease</h1>
      <h2 role="title" className="main-header d-block fw-bolder fst-italic text-uppercase display-6 mb-4">know more about apple scab disease</h2>
        <div className="mb-4">
            <h3 className='fs-5 fw-bold'>How to identify apple scab</h3>
            <ul className="col-12 fs-6">
                <li className="">Leaf spots are round, olive-green in color and up to ½-inch across.</li>
                <li className="">Spots are velvet-like with fringed borders.</li>
                <li className="">As they age, leaf spots turn dark brown to black, get bigger and grow together.</li>
                <li className="">Leaf spots often form along the leaf veins.</li>
                <li className="">Leaves with many leaf spots turn yellow and drop by mid-summer.</li>
                <li className="">Infected fruit have olive-green spots that turn brown and corky with time.</li>
                <li className="">Fruit that are infected when very young become deformed and cracked as the fruit grows.</li>
            </ul>
            <div className="d-flex align-items-center">
                <div className='col-4 p-1 p-md-2'>
                    <img src={images.main.unhealth_apple_1} alt="..." className='w-100 h-100 rounded-1' style={{"objectFit": "cover"}} />
                </div>
                <div className='col-4 p-1 p-md-2'>
                    <img src={images.main.unhealth_leave_1} alt="..." className='w-100 h-100 rounded-1' style={{"objectFit": "cover"}} />
                </div>
                <div className='col-4 p-1 p-md-2'>
                    <img src={images.main.unhealth_leave_2} alt="..." className='w-100 h-100 rounded-1' style={{"objectFit": "cover"}} />
                </div>
            </div>
        </div>
        <div className="d-flex flex-column mb-4">
            <h3 className='fs-5 fw-bold'>How does apple scab survive and spread?</h3>
           <p className='fs-6'>
        ...
        <div className="d-flex flex-column mb-4">
            <h3 className='fs-5 fw-bold'>How to manage apple scab in apples and crabapples</h3>
            <p className='fs-6'>
            ...
            <div className="accordion" id="accordionExample">
                <div className="accordion-item">
                    <h4 className="accordion-header" id="headingOne">
                        <button className="accordion-button fw-bold fs-5" type="button" data-bs-toggle="collapse" data-bs-target="#collapse1" aria-expanded="true" aria-controls="collapseOne">
                            Cultural practices
                        </button>
                    </h4>
                    <div id="collapse1" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <div className="accordion-body">
                            ...
                            <ul className="col-12 fs-6">
                                <li className="">Rake up and destroy fallen leaves before the first snowfall.</li>
                                <li className="">Infected leaves can be burned, buried or composted.</li>
                                <li className="">Instead of raking, leaves can be chopped with a mulching lawn mower.</li>
                                <li className="">Fall lawn fertilizer applications will help breakdown leaves that have been chopped with a mulching lawn mower.</li>
                                <li className="">In mulched areas, urea can be applied to chopped leaf litter to help with decomposition.</li>
                            </ul>
                            ...
                            <ul className="col-12 fs-6">
                                <li className="">Do not overcrowd plants. Use the mature size of the tree as a spacing guide.</li>
                                <li className="">Prune trees so that the branches are spaced far enough apart to let air move through the branches and dry the leaves quickly.</li>
                                <li className="">Remove upright suckers and water sprouts that have formed along the main trunk or within the canopy.</li>
                            </ul>
                        </div>
                    </div>
                </div>
